...
export default function Art({ navigation }) {
  const categories = [
    { id: '1', title: 'Art Exhibitions', image: require('../../assets/Art1.jpg') },
    { id: '2', title: 'Galeries', image: require('../../assets/Art2.jpg') },
    { id: '3', title: 'More', image: require('../../assets/Art3.jpg') },
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Art</Text>
        <View style={{ width: 24 }} />
      </View>
