...
export default function Theatre({ navigation }) {
  const categories = [
    { id: '1', title: 'Plays', image: require('../../assets/Theartre2.jpeg') },
    { id: '2', title: 'Musicals', image: require('../../assets/Theatre1.jpeg') },
    { id: '3', title: 'More', image: require('../../assets/Theartre3.jpeg') },
