...
export default function Sports({ navigation }) {
  const categories = [
    { id: '1', title: 'Football', image: require('../../assets/sixth.png') },
    { id: '2', title: 'Basketball', image: require('../../assets/Sport2.png') },
    { id: '3', title: 'Handball', image: require('../../assets/sport3.png') },
